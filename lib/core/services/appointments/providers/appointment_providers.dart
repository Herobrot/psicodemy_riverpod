...
final updateAppointmentStatusProvider = FutureProvider.family<AppointmentModel, Map<String, dynamic>>((ref, params) async {
  final service = ref.watch(appointmentServiceProvider);
  return await service.updateAppointmentStatus(params['id'], params['request']);
});

final deleteAppointmentProvider = FutureProvider.family<bool, String>((ref, id) async {
  final service = ref.watch(appointmentServiceProvider);
...
final detailedHealthCheckProvider = FutureProvider<Map<String, dynamic>>((ref) async {
  final service = ref.watch(appointmentServiceProvider);
