...
final tutorAppointmentsProvider =
    FutureProvider.family<List<AppointmentEntity>, String>((
      ref,
      tutorId,
    ) async {
...
final appointmentStatsProvider =
    FutureProvider.family<Map<String, int>, String>((ref, tutorId) async {
      final useCases = ref.watch(appointmentUseCasesProvider);
...
final completedAppointmentsThisMonthProvider =
    FutureProvider.family<List<AppointmentEntity>, String>((
      ref,
      tutorId,
    ) async {
...
final tutorAppointmentsStreamProvider =
    StreamProvider.family<List<AppointmentEntity>, String>((ref, tutorId) {
      final useCases = ref.watch(appointmentUseCasesProvider);
...
final appointmentByIdProvider =
    FutureProvider.family<AppointmentEntity?, String>((
      ref,
      appointmentId,
    ) async {
      final useCases = ref.watch(appointmentUseCasesProvider);
...
final nextStudentAppointmentProvider =
    FutureProvider.family<AppointmentEntity?, String>((ref, studentId) async {
      final useCases = ref.watch(appointmentUseCasesProvider);
